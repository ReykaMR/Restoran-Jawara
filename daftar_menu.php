...
?>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg  bg-dark">
            <div class="container">
                <a class="navbar-brand text-white" href="admin.php"><strong>JAWARA</strong> RESTO</a>
                    ...
                    <div class="col-md-3 mt-4">
                        <div class="card brder-dark">
                            ...
                            <div class="card-body">
                                ...
                                <a href="hapus_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-danger btn-sm btn-block text-light" onclick="return confirm('Anda yakin mau menghapus item ini ?')">HAPUS</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
