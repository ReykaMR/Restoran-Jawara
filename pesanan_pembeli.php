    ...
    <body>
        ...
        <div class="container">
                ...
                <tbody>
                    ...
                    <?php foreach ($_SESSION["pesanan"] as $id_menu => $jumlah) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="hapus_pesanan.php?id_menu=<?php echo $id_menu ?>" class="badge badge-danger" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a>
                            </td>
                        </tr>
                        <?php $nomor++; ?>
            ...
            <form method="POST" action="">
                ...
                <button class="btn btn-success btn-sm" name="konfirm">Bayar Pesanan</button>
            </form>
