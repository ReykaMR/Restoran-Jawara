                    ...
                    <?php foreach ($result as $result) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="clear_pesanan.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-danger" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus Data</a>
                            </td>
                        </tr>
                        <?php $nomor++; ?>
                    <?php endforeach; ?>
